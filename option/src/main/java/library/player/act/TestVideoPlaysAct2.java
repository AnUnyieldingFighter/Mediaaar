...
import library.player.adapter.VideoPagerAdapter2;
import library.player.bean.TestVideoUrl;
import library.player.frg.VideoBaseFrg;
import library.player.frg.VideoFrg;
import library.player.manager.PlayerLog;
